...
class TeleOp202TestingLogic extends Logic_Base {
    ...
    public void execute_non_driver_controlled() {
        ...
        robot.telemetry.addData("joint2 data", robot.dc_motor_list[1].getCurrentPosition());
        robot.telemetry.addData("joint2 data", target_positions[1]);
    ...
    public void set_keybinds() {
        ...
        new_keybind("clawAligner", "operator x", "default", 0.2, "it's great to be a michigan wolverine");
        new_keybind("clawAligner", "operator y", "default", -0.2, "it's great to be a michigan wolverine");
